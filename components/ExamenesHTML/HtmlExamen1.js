          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div>
                ...
                />
                <label htmlFor="incorrecta">Un lenguaje de programación para desarrollo web.</label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="var-bernese">Un sistema de gestión de bases de datos. </label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="var-linus">El lenguaje estándar para crear páginas web.</label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="incorrecta">Una herramienta para diseño gráfico.</label>
              </div>
            </div>
            {/* pregunta  */}
            <div>
              <label className="block font-bold">
              ¿Cómo se estructura el contenido de una página web utilizando HTML?
              </label>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="pregunta2">Utilizando etiquetas como &lt;script&gt; y &lt;style&gt;.</label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="pregunta2">Mediante el uso de etiquetas como &lt;head&gt; y &lt;body&gt;. </label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="incorrecta2"> Empleando solo etiquetas de texto como &lt;p&gt; y &lt;h1&gt;. </label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="incorrecta"> No es posible estructurar contenido con HTML.</label>
              </div>
            </div>
            ...
            <div>
              <label className="block font-bold">
              ¿Cuál de las siguientes etiquetas se utiliza para definir un párrafo en HTML?
              </label>
              ...
              <div>
                ...
                />
                <label htmlFor="incorrecta3"> &lt;div&gt; </label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="pregunta3">&lt;p&gt;</label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="determine1">&lt;span&gt;</label>
              </div>
              <div>
                <input
                  type="radio"
                ...
                />
                <label htmlFor="incorrecta2">&lt;section&gt; </label>
              </div>
