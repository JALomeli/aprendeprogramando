      ...
      <div className="flex flex-col bg-white justify-center items-center min-h-screen min-w-screen text-center m-5 p-5">
        ...
        <Accordion className="w-full max-w-4xl">
          <Accordion.Panel>
            ...
            <Accordion.Content>
              <div>
                <h2 className="text-2xl font-bold mb-2">Historia de JavaScript</h2>
                <p>
                  JavaScript es un lenguaje de programación de alto nivel, interpretado y orientado a objetos, desarrollado originalmente por Brendan Eich en 1995.
                </p>
                <p>
                  Surgió como una herramienta para agregar interactividad a las páginas web en el navegador Netscape Navigator.
                </p>
                <p>
          ...
          <Accordion.Panel>
            <Accordion.Title>Lección 2: Variables y Tipos de Datos en JavaScript</Accordion.Title>
            <Accordion.Content>
              <div>
                <h2 className="text-2xl font-bold mb-2">Variables en JavaScript</h2>
                <p>Una variable en JavaScript se utiliza para almacenar datos.</p>
                <p>
                  Para declarar una variable, se utiliza la palabra clave <code>var</code>, <code>let</code>, o <code>const</code>.
                </p>
                <p>Por ejemplo:</p>
          ...
          <Accordion.Panel>
            <Accordion.Title>Lección 3: Operadores y Expresiones en JavaScript</Accordion.Title>
            <Accordion.Content>
              <div>
                <h2 className="text-2xl font-bold mb-2">Operadores Aritméticos</h2>
                <p>JavaScript incluye operadores aritméticos estándar para realizar operaciones matemáticas básicas:</p>
                <ul className="list-disc pl-5">
                  <li>Suma (+)</li>
                  <li>Resta (-)</li>
              ...
              <div>
                <h2 className="text-2xl font-bold mb-2">Operadores de Comparación</h2>
                <p>Los operadores de comparación se utilizan para comparar valores:</p>
                <ul className="list-disc pl-5">
                  <li>Igualdad (==)</li>
          ...
          <Accordion.Panel>
            <Accordion.Title>Lección 4: Estructuras de Control en JavaScript</Accordion.Title>
            <Accordion.Content>
              <div>
                <h2 className="text-2xl font-bold mb-2">Sentencia if</h2>
                <p>La sentencia `if` se utiliza para ejecutar un bloque de código si una condición es verdadera.</p>
              </div>
              <div>
                <h2 className="text-2xl font-bold mb-2">Bucle for</h2>
                <p>El bucle `for` se utiliza para repetir una serie de declaraciones varias veces.</p>
              </div>
              <div>
          ...
          <Accordion.Panel>
            <Accordion.Title>Lección 5: Funciones en JavaScript</Accordion.Title>
            <Accordion.Content>
              <div>
                <h2 className="text-2xl font-bold mb-2">Definir funciones</h2>
                <p>Las funciones se definen con la palabra clave `function` seguida por el nombre de la función y los paréntesis `()`, que pueden contener parámetros.</p>
              </div>
              <div>
                <h2 className="text-2xl font-bold mb-2">Llamar funciones</h2>
                <p>Para llamar a una función, simplemente escribe el nombre de la función seguido de paréntesis `()`.</p>
              </div>
              <div>
